        ...
        <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          ...
          <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
            ...
            <p>
              ...
              <b>Full Stack Developer at PASS Consulting Group</b>, where I
              design and develop scalable web applications using
              <b>Angular</b> and <b>Spring Boot</b>. I also have strong
              experience with <b>Django</b>, <b>Vue.js</b>, and <b>React.js</b>{" "}
              from my freelance projects.
            </p>
            <p>
              My journey includes developing <b>e-commerce platforms</b>,
              implementing <b>AI-based modules</b> such as recommendation
              systems and chatbots, and creating{" "}
              <b>Business Intelligence dashboards</b> with <b>Power BI</b> and
              ETL processes.
            </p>
            <p>
              I’m skilled in <b>Python, Java, PHP, and JavaScript</b>, and
              familiar with modern development and deployment tools like
              <b>Docker</b>, <b>GitLab CI/CD</b>, <b>PostgreSQL</b>, and{" "}
              <b>MongoDB</b>.
            </p>
            <p>
